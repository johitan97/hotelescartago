      ...
      <div className="column is-one-third">
        <div className="card">
                ...
                <div className="field is-grouped is-grouped-multiline" style={{marginTop: '2em'}}>
                    ...
                    <div className="control">
                        <div className="tags has-addons">
                            ...
                            <span className="tag is-medium tag-text">{rooms} Las Habitaciones</span>
                        </div>
                    </div>
                    <div className="control">
                        <div className="tags">
            ...
            <div className="card-footer">
              <p className="card-footer-item has-background-primary has-text-white has-text-weight-bold">Reservar el hotel</p>
            </div>
        </div>
        </div>
    )
